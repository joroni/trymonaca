     ...
     */
    (function (t, e) {
        "object" == typeof exports ? module.exports = e(require("spin.min.js")) : "function" == typeof define && define.amd ? define(["spin"], e) : t.Ladda = e(t.Spinner)
    })(this, function (t) {
        "use strict";

        function e(t) {
            if (t === void 0) return console.warn("Ladda button target must be defined."), void 0;
            $(".ladda-label") || (html('<span class="ladda-label">' + t.innerHTML + "</span>"));

            var e, n = $(".ladda-spinner");
            n || (n = $(this).append("span"), n.addClass("ladda-spinner")), t.append(n);
            var r, a = {
                start: function () {
        ...
        function r(t) {
            for (var e = ["input", "textarea", "select"], n = [], r = 0; e.length > r; r++)
                for (var a = t.$(e[r]), i = 0; a.length > i; i++) a[i].hasAttribute("required") && n.push(a[i]);
            return n
        }
